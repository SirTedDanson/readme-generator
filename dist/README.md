  ...
  This application generates a README file via user prompts in the node.js runtime environment
  ...
  Perform a git clone of the rep, open the local repo in VSCODE, run 'node index' in the terminal
